...
const SidebarComponent = () => {
  ...
  <div className='sm:block md:hidden' >
    ...
    <CiMenuFries  className=' text-4xl text-orange-500 '  onClick={showDrawer}/>
    </div>
  <Drawer className='' title="Үндсэн цэс" placement="left" onClose={onClose} open={open}  height="100%">
  <Collapse accordion>
    <Panel header="Нүүр" key="1">
      <a  href="/" className='flex h-8 w-full justify-start items-center'><div className='text-xl flex justify-center w-12'><AiOutlineHome/></div> Нүүр</a>
    </Panel>
    ...
    <div className='divide-y space-y-3'>
    <a href="/suld"  className='flex h-8 w-full justify-start items-center'><div className='text-xl flex justify-cente  w-12' > <FaHouseDamage/> </div>  Сүлд ERP</a>
    </div>
    </Panel>
    <Panel header="Захиалга"  key="7">
      <div className='divide-y space-y-3'>
          <a href="/asuulguud" className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <AiOutlineQuestionCircle/> </div>Асуулгууд</a>
           <a href="/orders"  className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <BsCartPlus/> </div>Захиалгууд</a>
           <a href="#"  className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <MdEmojiTransportation/> </div>Тээврийн захиалга</a>
    
      </div>
    </Panel>
    <Panel header="Захиалгийн систем"  key="8">
      <div className='divide-y space-y-3'>
           <a href="#" className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <TbListDetails/> </div> Сэлбэгийн удирдлага</a>
           <a href="#" className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <MdPriceCheck/> </div>Нийлүүлэгчийн үнэ</a>
      </div>
    </Panel>
    ...
    <Panel header="NEXUS"  key="11">
      <div className='divide-y space-y-3'>
           <a href="#" className='flex h-8 w-full justify-start items-center'><div className='text-xl flex justify-cente  w-12' > <GrUserWorker/> </div> Ажилчид</a>
           <a href="#"  className='flex h-8 w-full justify-start items-center'><div className='text-xl flex justify-cente  w-12' > <SlNote/> </div> Сургалт</a>
           <a href="#"   className='flex h-8 w-full justify-start items-center'><div className='text-xl flex justify-cente  w-12' > <TbBrandBooking/> </div> Брэнд бүүк</a>
      </div>
    </Panel>
    <Panel header="Тохиргоо"  key="12">
      <div className='divide-y space-y-3'>
           <a href="#" className='flex h-8 w-full justify-start items-center' ><div className='text-xl flex justify-cente  w-12' > <TbZoomMoney/> </div>Үнийн тохиргоо</a>
           <a href="/notifications" className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <VscBellDot/> </div>Мэдэгдэл илгээх</a>
           <a href="/feedback" className='flex h-8 w-full justify-start items-center'> <div className='text-xl flex justify-cente  w-12' > <BsChatSquareQuote/> </div>Санал хүсэлт</a>
      </div>
    </Panel>
